(function (React, ReactDOM) {
    ...
    ***************************************************************************** */
    ...
    var ApolloProvider = function (_a) {
        ...
        return React__default['default'].createElement(ApolloContext.Consumer, null, function (context) {
            if (context === void 0) { context = {}; }
            ...
            return (React__default['default'].createElement(ApolloContext.Provider, { value: context }, children));
        });
    };
    ...
    var COUNTRIES = src(_templateObject());

    var Countries = function Countries() {
      var _useQuery = useQuery(COUNTRIES),
      ...
      return data.Country.map(function (_ref) {
        var _currencies$;

        var alpha3Code = _ref.alpha3Code,
            currencies = _ref.currencies,
            name = _ref.name;
        return /*#__PURE__*/React__default['default'].createElement("div", {
          key: alpha3Code
        }, /*#__PURE__*/React__default['default'].createElement("p", null, "(", alpha3Code, ") ", name, ": ", currencies === null || currencies === void 0 ? void 0 : (_currencies$ = currencies[0]) === null || _currencies$ === void 0 ? void 0 : _currencies$.code));
      });
    };
    ...
    var App = function App(_props) {
      return /*#__PURE__*/React__default['default'].createElement(ApolloProvider, {
        client: client
      }, /*#__PURE__*/React__default['default'].createElement("div", null, "Test apollo invalidation app"), /*#__PURE__*/React__default['default'].createElement("div", {
        style: {
          marginTop: 30
        }
      }, /*#__PURE__*/React__default['default'].createElement(Countries, null)));
    };
